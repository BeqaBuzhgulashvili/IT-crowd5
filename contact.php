							...
							<nav class="navbar_ navbar navbar-expand-md clearfix">
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent">
									<ul class="nav navbar-nav sf-menu clearfix">
										...
										<a class="nav-link" href="?lang=ka"><img src="images/lang-ka.png"><?=checked($lang, "ka");?>
									</a>
									<a class="nav-link" href="?lang=en"><img src="images/lang-en.png"><?=checked($lang, "en");?></a>
									</li>
									</ul>
								</div>
							</nav>
					...
					<div id="content" class="page-section">
						<div class="container">
							...
							<div class="row">
								...
								<div class="row">
                            <div class="col-md-8 text-center textCenter center-class" style="margin-left: auto;">
                                <form id="ajax-contact-form" class="form-horizontal clearfix" action="javascript:;">
                                    ...
                                    <button type="submit" class="btn1 btn-cf-submit"><?=$tr["send"][$lang];?></button>
                                </form>
                            </div>
                        </div>
...
<div class="color-class">
							...
							</div>							<div class="copyrights">Copyright @2020 <a href="index.php" target="_blank">ITCrowd</a>. <?=$tr["copyright"][$lang];?></div>
