                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="nav navbar-nav sf-menu clearfix">
                                    ...
                                    <li class="nav-item" style="display: flex;">
                                        <a class="nav-link" href="?lang=ka"><img src="images/lang-ka.png">
                                            <?=checked($lang, "ka");?>
                                        </a>
                                        <a class="nav-link" href="?lang=en"><img src="images/lang-en.png">
                                            <?=checked($lang, "en");?>
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="bot2-wrapper">
                    <div class="container">
                        <div class="bot2 clearfix">
                            ...
                            <div class="copyrights">Copyright @2020 <a href="index.php" target="_blank">ITCrowd</a>.
                                <?=$tr["copyright"][$lang];?>
                            </div>
